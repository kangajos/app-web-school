...
<head>
	...
	<!-- Font Awesome -->
	<link rel="stylesheet" href="<?= base_url('myassets/adminlte') ?>/plugins/fontawesome-free/css/all.min.css">
	<!-- Ionicons -->
	<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
	<!-- icheck bootstrap -->
	<link rel="stylesheet" href="<?= base_url('myassets/adminlte') ?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
	<!-- Theme style -->
	<link rel="stylesheet" href="<?= base_url('myassets/adminlte') ?>/dist/css/adminlte.min.css">
