...
<aside class="main-sidebar sidebar-dark-purple elevation-4">
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<?= base_url('myassets/adminlte') ?>/dist/img/user2-160x160.jpg"
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<?php if ($this->session->userdata("level") == "admin"): ?>
					<li class="nav-item">
						<a href="<?= base_url("admin/dashboard") ?>"
						   class="nav-link <?= $contents['active'] == 'dashboard' ? 'active' : '' ?>">
							<i class="nav-icon fa fa-home"></i>
							<p>Dashboard</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url("admin/jadwal/absensi") ?>"
						   class="nav-link <?= $contents['active'] == 'absensi' ? 'active' : '' ?>">
					...
					<li class="nav-item">
						<a href="<?= base_url("admin/kelas") ?>"
						   class="nav-link <?= $contents['active'] == 'kelas' ? 'active' : '' ?>">
							<i class="nav-icon fa fa-book-reader"></i>
							<p>Kelas</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url("admin/mapel") ?>"
						   class="nav-link <?= $contents['active'] == 'mapel' ? 'active' : '' ?>">
							<i class="nav-icon fa fa-book-reader"></i>
							<p>Mapel</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url("admin/jadwal") ?>"
						   class="nav-link <?= $contents['active'] == 'jadwal' ? 'active' : '' ?>">
							<i class="nav-icon fa fa-book-reader"></i>
							<p>Jadwal Mapel</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url("admin/spp") ?>"
						   class="nav-link <?= $contents['active'] == 'spp' ? 'active' : '' ?>">
					...
					<li class="nav-item">
						<a href="<?= base_url("admin/siswa") ?>"
						   class="nav-link <?= $contents['active'] == 'siswa' ? 'active' : '' ?>">
					...
					<li class="nav-item">
						<a href="<?= base_url("admin/guru") ?>"
						   class="nav-link <?= $contents['active'] == 'guru' ? 'active' : '' ?>">
							<i class="nav-icon fa fa-user-plus"></i>
							<p>Guru</p>
						</a>
					</li>
					<li class="nav-item">
						<a href="<?= base_url("admin/user") ?>"
						   class="nav-link <?= $contents['active'] == 'user' ? 'active' : '' ?>">
							<i class="nav-icon fa fa-user-plus"></i>
							<p>Admin</p>
						</a>
					</li>
				...
				<!--				</li>-->
				<!--				<li class="nav-item">-->
				<!--					<a href="--><? //=base_url("admin/price")?><!--" class="nav-link -->
